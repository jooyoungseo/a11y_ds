...
# Verifying R and VSCode Installation {#sec-confirm-installation}
...
8. From R terminal, press `Ctrl+Tab` to come back to the test.R file. You will hear something like "test dot R." Now you can switch between the R terminal and the test.R file back and forth by pressing `Ctrl+Tab` key.
